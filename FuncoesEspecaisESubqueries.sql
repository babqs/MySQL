...
SELECT COUNT(*) FROM funcionarios WHERE salario > 1600 AND departamento = 'TI';
SELECT * FROM funcionarios WHERE salario > 1600 AND departamento = 'TI';
...
SELECT AVG(salario) FROM funcionarios GROUP BY departamento HAVING AVG(salario) > 2000;
